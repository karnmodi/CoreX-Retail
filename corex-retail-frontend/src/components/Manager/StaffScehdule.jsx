...
const StaffSchedule = () => {
  ...
  // Generate week dates based on a given date
  ...
  const filteredShifts = useMemo(() => {
    return shifts.filter(shift => {
      ...
      return new Date(shiftDate).toLocaleDateString('en-US', { weekday: 'long' }) === selectedDay;
    });
  }, [shifts, selectedDay]);
  ...
  const navigateWeek = (direction) => {
    ...
    if (direction === 'prev') {
      ...
      setCurrentWeek(prevWeek => 
        prevWeek === "This Week" ? "Last Week" : 
        prevWeek === "Next Week" ? "This Week" : "Next Week"
      );
    } else {
      newDate = currentWeek === "This Week" 
        ? new Date(currentDateObj.setDate(currentDateObj.getDate() + 7))
      ...
      setCurrentWeek(prevWeek => 
        prevWeek === "This Week" ? "Next Week" : 
        prevWeek === "Last Week" ? "This Week" : "Last Week"
      );
    }
  ...
  // Determine shift status color and style
  ...
  return (
    <div className="bg-white rounded-2xl shadow-sm overflow-hidden">
      ...
      <div className="p-4 border-b border-gray-200">
        <div className="flex justify-between items-center mb-4">
          <div>
            ...
            <p className="text-sm text-gray-500">View and manage staff schedules</p>
          </div>
      ...
      <div className="p-4">
        {loading ? (
          <div className="text-center text-gray-500 py-4">Loading shifts...</div>
        ) : error ? (
